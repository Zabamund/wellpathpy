...
# get data series
well9_true_md_m = well9['Measured Depth ( ft )'].values / 3.2808 # converting feet to meters
well9_true_inc = well9['Inclination ( deg )'].values
well9_true_azi = well9['Azimuth Grid ( deg )'].values
well9_true_tvd_m = well9['TVD ( ft )'].values / 3.2808 # converting feet to meters
...
well9_true_datum_elevation = 100 / 3.2808 # converting feet to meters

well10_true_md_m = well10['Measured Depth ( ft )'].values / 3.2808 # converting feet to meters
well10_true_inc = well10['Inclination ( deg )'].values
well10_true_azi = well10['Azimuth Grid ( deg )'].values
well10_true_tvd_m = well10['TVD ( ft )'].values / 3.2808 # converting feet to meters
...
well10_true_datum_elevation = 100 / 3.2808 # converting feet to meters
